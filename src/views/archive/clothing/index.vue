          ...
          <el-col :span="8">
            <el-form-item label="颜色" prop="color">
              <el-select v-model="newClothing.color" multiple collapse-tags placeholder="请选择颜色">
                <el-option v-for="item in colorList" :key="item.value" :label="item.text" :value="item.value"> </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="风格" prop="style">
              <el-select v-model="newClothing.style" multiple collapse-tags placeholder="请选择风格">
                <el-option v-for="item in styleList" :key="item.value" :label="item.text" :value="item.value"> </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
  ...
  methods: {
    ...
    postClothing() {
      this.$refs.newClothingRef.validate(valid => {
        ...
        addClothing(this.newClothing).then(res => {

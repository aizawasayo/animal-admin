        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="交易类型" prop="exchangeType" required>
              <el-cascader v-model="newTrade.exchangeType" :options="exchangeOption" separator="-" clearable></el-cascader>
            </el-form-item>
          </el-col>
          <el-col :span="8">
          ...
          <el-col :span="24">
            <el-form-item label="上岛说明" prop="detail">
              <el-input v-model="newTrade.detail" type="textarea" placeholder="门票、报酬等等，需要补充的内容都填这里" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>

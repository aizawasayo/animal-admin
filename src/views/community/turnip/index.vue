<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="交易方式" align="center" prop="exchangeType" column-key="exchangeType" :filters="exchangeList">
        <template slot-scope="scope">
        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="上岛说明" prop="detail">
              <el-input v-model="newTurnip.detail" type="textarea" placeholder="门票、报酬等等，需要补充的内容都填这里" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
